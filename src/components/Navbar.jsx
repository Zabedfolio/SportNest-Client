...
import { MdSportsVolleyball, MdCalendarToday, MdAddCircleOutline, MdSettings, MdLogout } from 'react-icons/md';
...
const Navbar = () => {
    ...
    return (
        <nav className="bg-base-100 border-b border-base-200 px-6 h-16 flex items-center justify-between sticky top-0 z-50">
            {/* Logo */}
...
/>
                ...
                <Link href="/login"
                    className="bg-[#0F6E56] hover:bg-[#2FA084] text-white text-sm font-medium px-5 py-2 rounded-full transition-all">
                    Login
                </Link>
            )}
        </nav>
